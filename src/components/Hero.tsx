...
export function Hero() {
  return (
    <section id="topo" className="relative z-10 px-5 pt-24 pb-12 md:px-8 md:pt-28 md:pb-16">
      <div className="mx-auto max-w-6xl">
        <p className="font-pixel text-[8px] leading-relaxed text-gold uppercase md:text-[10px]">
          {games.length} registros
        </p>

        <h1 className="mt-5 font-display text-5xl leading-[0.95] font-bold tracking-[0.14em] text-bone sm:text-7xl md:text-8xl">
          MEMORIAL
          <span className="mt-1 block text-gold">DE JOGOS</span>
        </h1>

        <p className="font-brush mt-4 text-3xl text-ember md:text-4xl">記録</p>
